...
async function createMcpServer() {
  ...
  server.tool('search_templates', 'Search workflow templates by keyword, category, or list all', {
  ...
  server.tool('get_template', 'Get full template details including workflow JSON', {
  ...
  server.tool('list_tickets', 'List support tickets with optional filters', {
  ...
  server.tool('get_ticket', 'Get ticket details with comments and activity', {
  ...
  server.tool('search_kb_articles', 'Search knowledge base articles', {
    query: { type: 'string', description: 'Search query (optional)' },
  ...
  server.tool('get_kb_article', 'Get full knowledge base article content', {
  ...
  server.tool('get_stats', 'Get dashboard statistics (tickets, articles, templates)', {}, async () => {
  ...
  server.tool('list_users', 'List all users with their roles', {}, async () => {
    const { rows } = await pool.query(
